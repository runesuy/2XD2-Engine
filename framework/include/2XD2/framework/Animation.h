...
namespace e2XD::framework
{
    ...
    public:
        Animation() = default;
        Animation(const std::initializer_list<sf::Texture*> &frameList, float frameDuration, bool isLooping = false);
        ...
        [[nodiscard]] const std::vector<sf::Texture*>& getFrames() const;
